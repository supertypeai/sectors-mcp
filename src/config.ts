...
export const SECTORS_API_BASE = process.env.SECTORS_API_BASE || "https://api.sectors.app/v1";
export const SECTORS_API_BASE_V2 = process.env.SECTORS_API_BASE_V2 || "https://api.sectors.app/v2";
